...
create table Orders (id bigint generated by default as identity, fechaCaducidad date, fechaContratacion date, nombre varchar2(255), producto_id bigint, usuario_id bigint, primary key (id))
create table Product (type varchar2(31) not null, id bigint generated by default as identity, almacenamiento integer not null, anchoBanda integer not null, disabled boolean not null, mensualidad double not null, tipo varchar2(255), primary key (id))
...
create table User (id bigint generated by default as identity, admin boolean not null, email varchar2(255), pass varchar2(255), saldo double not null, usuario varchar2(50), primary key (id))
